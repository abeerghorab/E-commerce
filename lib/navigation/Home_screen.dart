...
import 'product_overview.dart'; // استوردي صفحة التفاصيل
...
class HomePage extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      productCard(context, "assets/image1.jpg", "T-Shirt", 55, 300),
                      productCard(context, "assets/image2.jpg", "Jacket", 666, 100),
                      productCard(context, "assets/image3.jpg", "Child Jacket", 323, 600),
                      productCard(context, "assets/image4.jpg", "Hooded", 55, 300),
                      productCard(context, "assets/image5.jpg", "Shall", 55, 300),
                    ],
                  ),
                ),
                ...
                Row(
                  children: [
                    SizedBox(width: 15),
                    productCard(context, "assets/image2.jpg", "Jacket", 200, 150),
                    SizedBox(width: 55),
                    productCard(context, "assets/image1.jpg", "T-Shirt", 120, 80),
                  ],
                ),
                ...
                Row(
                  children: [
                    SizedBox(width: 15),
                    productCard(context, "assets/image3.jpg", "Child Jacket", 200, 150),
                    SizedBox(width: 55),
                    productCard(context, "assets/image5.jpg", "Shall", 120, 80),
                  ],
                ),
              ],
            ),
  ...
  Widget productCard(BuildContext context, String imagePath, String name, int reviews, int price) {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    productCard(context, "assets/image5.jpg", "Shawl", 120, 80),
                  ],
                ),
              ],
            ),
